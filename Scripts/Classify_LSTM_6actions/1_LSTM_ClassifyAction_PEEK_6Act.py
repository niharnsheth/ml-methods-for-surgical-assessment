...
#train_list = [f for f in os.listdir(source_path + data_folder) if fnmatch.fnmatch(f, '*.csv')]
#test_list = [f for f in os.listdir(source_path + data_folder_test) if fnmatch.fnmatch(f, '*.csv')]
test_list = []
test_subjects = []
train_list = []
...
for i in range(epochs):
    ...
    saver.save(sess, source_path + 'Saved/my-test-model_1')
