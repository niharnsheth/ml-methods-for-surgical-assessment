...
data_path = "D:\Documents-DataDrive\Pythonfiles\TensorFlowTutorials\simple-examples\data"
...
def chomu_test(model_path, test_data, reversed_dictionary):
...
if args.run_opt == 1:
    ...
    chomu_test(trained_model, test_data, reversed_dictionary)